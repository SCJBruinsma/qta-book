...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vector1 }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}This is the first of our character vectors\textquotesingle{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vector2 }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}This is an example\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}This is another\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}And so we can go on.\textquotesingle{}}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vector3 }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}This is yet another sentence\textquotesingle{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vector3 }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}Here is a sentence {-} And a second\textquotesingle{}}
\NormalTok{parts1 }\OtherTok{\textless{}{-}} \FunctionTok{strsplit}\NormalTok{(vector3, }\StringTok{\textquotesingle{}{-}\textquotesingle{}}\NormalTok{)}
\NormalTok{parts1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vector4 }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}Here is another sentence {-} And one more\textquotesingle{}}
\NormalTok{parts2 }\OtherTok{\textless{}{-}} \FunctionTok{strsplit}\NormalTok{(vector4, }\StringTok{\textquotesingle{}{-}\textquotesingle{}}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fruits }\OtherTok{\textless{}{-}} \FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}oranges\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}lemons\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}pears\textquotesingle{}}\NormalTok{, }\AttributeTok{sep =} \StringTok{\textquotesingle{}{-}\textquotesingle{}}\NormalTok{)}
\NormalTok{fruits}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sentences }\OtherTok{\textless{}{-}} \FunctionTok{paste}\NormalTok{(vector3, vector4, }\AttributeTok{sep =} \StringTok{\textquotesingle{}.\textquotesingle{}}\NormalTok{)}
\NormalTok{sentences }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{extract }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(filename) \{}
 ...
 \FunctionTok{try}\NormalTok{(\{text }\OtherTok{\textless{}{-}}\FunctionTok{pdf\_text}\NormalTok{(filename)\})}
\NormalTok{ f }\OtherTok{\textless{}{-}}\FunctionTok{gsub}\NormalTok{(}\StringTok{"(.*)/([\^{}/]*).pdf"}\NormalTok{, }\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{2"}\NormalTok{, filename)}
 \FunctionTok{write}\NormalTok{(text,}\FunctionTok{file.path}\NormalTok{(txt\_directory,}\FunctionTok{paste0}\NormalTok{(f, }\StringTok{".txt"}\NormalTok{)))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{directory }\OtherTok{\textless{}{-}}\FunctionTok{getwd}\NormalTok{()}
\NormalTok{data\_texts }\OtherTok{\textless{}{-}}\FunctionTok{readtext}\NormalTok{(}\FunctionTok{paste0}\NormalTok{(txt\_directory, }\StringTok{"*"}\NormalTok{), }\AttributeTok{encoding =} \StringTok{"UTF{-}8"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
The Manifesto Project collects the electoral manifestos that have been released by major parties across the OECD countries since 1945, and trains human coders to classify their content using a custom-made coding scheme (\protect\hyperlink{ref-Volkens2019a}{Volkens et al. 2019}). Using the Manifesto Project API we can download the text of many of these manifestos along with the annotations made by the trained coders (see \protect\hyperlink{ref-Merz2016}{Merz, Regel, and Lewandowski} (\protect\hyperlink{ref-Merz2016}{2016})). In the following example we do this using the \texttt{manifestoR} package.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{corpus\_fdp }\OtherTok{\textless{}{-}} \FunctionTok{mp\_corpus}\NormalTok{(party }\SpecialCharTok{==} \DecValTok{41420} \SpecialCharTok{\&}\NormalTok{ date }\SpecialCharTok{==} \DecValTok{201709}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{path }\OtherTok{\textless{}{-}} \StringTok{"https://data.police.uk/api/crimes{-}street/all{-}crime?"}
\end{Highlighting}
\end{Shaded}
...
\AttributeTok{lat =} \FloatTok{51.523772}\NormalTok{,}
\AttributeTok{lng =} \SpecialCharTok{{-}}\FloatTok{0.158539}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{response }\OtherTok{\textless{}{-}} \FunctionTok{content}\NormalTok{(request, }\AttributeTok{as =} \StringTok{"text"}\NormalTok{, }\AttributeTok{encoding =} \StringTok{"UTF{-}8"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data\_crimes }\OtherTok{\textless{}{-}} \FunctionTok{fromJSON}\NormalTok{(response, }\AttributeTok{flatten =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coderid }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"coder1"}\NormalTok{,}\StringTok{"coder2"}\NormalTok{,}\StringTok{"coder3"}\NormalTok{,}\StringTok{"coder4"}\NormalTok{,}\StringTok{"coder5"}\NormalTok{,}\StringTok{"coder6"}\NormalTok{,}\StringTok{"coder7"}\NormalTok{,}\StringTok{"coder8"}\NormalTok{,}\StringTok{"coder9"}\NormalTok{,}\StringTok{"coder10"}\NormalTok{,}\StringTok{"coder11"}\NormalTok{,}\StringTok{"coder12"}\NormalTok{)}
...
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{163}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{155}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{)}

\NormalTok{data\_uncertainty }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(coderid, c0,c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,c20,n, }\AttributeTok{stringsAsFactors=}\ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{manifBSn }\OtherTok{\textless{}{-}}\NormalTok{ manifBSnRand }\OtherTok{\textless{}{-}}\FunctionTok{array}\NormalTok{(}\FunctionTok{as.matrix}\NormalTok{(data\_uncertainty[,}\DecValTok{2}\SpecialCharTok{:}\DecValTok{21}\NormalTok{]),}
 \FunctionTok{c}\NormalTok{(nman, }\DecValTok{20}\NormalTok{, nrepl}\SpecialCharTok{+}\DecValTok{1}\NormalTok{),}
 \AttributeTok{dimnames=}\FunctionTok{list}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{nman,}\FunctionTok{names}\NormalTok{(data\_uncertainty[,}\DecValTok{2}\SpecialCharTok{:}\DecValTok{21}\NormalTok{]), }\DecValTok{0}\SpecialCharTok{:}\NormalTok{nrepl))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dataBS }\OtherTok{\textless{}{-}}\FunctionTok{data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(data\_uncertainty[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{22}\NormalTok{], c0SE, c01SE, c02SE, c03SE, c04SE, c05SE,c06SE, c07SE, c08SE, c09SE, c10SE, c11SE, c12SE, c13SE, c14SE, c15SE, c16SE, c17SE,c18SE, c19SE, per0, per01, per02, per03, per04, per05, per06, per07, per08, per09,per10, per11, per12, per13, per14, per15, per16, per17, per18, per19))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data\_manifestos\_dfm }\OtherTok{\textless{}{-}} \FunctionTok{dfm}\NormalTok{(corpus\_manifestos, }\AttributeTok{remove =} \FunctionTok{stopwords}\NormalTok{(}\StringTok{"english"}\NormalTok{), }\AttributeTok{remove\_punct =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{remove\_numbers =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{data\_manifestos\_dfm }\OtherTok{\textless{}{-}} \FunctionTok{dfm\_tolower}\NormalTok{(data\_manifestos\_dfm, }\AttributeTok{keep\_acronyms =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{features }\OtherTok{\textless{}{-}} \FunctionTok{topfeatures}\NormalTok{(data\_manifestos\_dfm, }\DecValTok{50}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wordcloud\_dfm\_trim }\OtherTok{\textless{}{-}} \FunctionTok{dfm\_trim}\NormalTok{(data\_manifestos\_dfm, }\AttributeTok{min\_termfreq =} \DecValTok{40}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wordcloud\_dfm\_comp }\OtherTok{\textless{}{-}} \FunctionTok{dfm}\NormalTok{(corpus\_manifestos, }\AttributeTok{groups =} \StringTok{"Party"}\NormalTok{)}
\FunctionTok{textplot\_wordcloud}\NormalTok{(}\FunctionTok{dfm\_trim}\NormalTok{(wordcloud\_dfm\_comp, }\AttributeTok{min\_termfreq =} \DecValTok{20}\NormalTok{, }\AttributeTok{max\_words =} \DecValTok{40}\NormalTok{), }\AttributeTok{comparison =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dictionary\_results }\OtherTok{\textless{}{-}} \FunctionTok{dfm\_lookup}\NormalTok{(data\_manifestos\_dfm, data\_dictionary\_LaverGarry)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dic\_list }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\AttributeTok{economy =}\FunctionTok{c}\NormalTok{(}\StringTok{"tax*"}\NormalTok{, }\StringTok{"vat"}\NormalTok{, }\StringTok{"trade"}\NormalTok{), }\AttributeTok{social =}\FunctionTok{c}\NormalTok{(}\StringTok{"NHS"}\NormalTok{, }\StringTok{"GP"}\NormalTok{, }\StringTok{"health"}\NormalTok{), }\AttributeTok{devolution =} \FunctionTok{c}\NormalTok{(}\StringTok{"referendum"}\NormalTok{,}\StringTok{"leave"}\NormalTok{,}\StringTok{"independence"}\NormalTok{), }\AttributeTok{europe =} \FunctionTok{c}\NormalTok{(}\StringTok{"Brussels"}\NormalTok{,}\StringTok{"remain"}\NormalTok{,}\StringTok{"EU"}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dictionary\_created }\OtherTok{\textless{}{-}} \FunctionTok{dfm\_lookup}\NormalTok{(data\_manifestos\_dfm, dic\_created)}
...
\NormalTok{reviews\_dfm }\OtherTok{\textless{}{-}} \FunctionTok{dfm}\NormalTok{(reviews)}
\end{Highlighting}
\end{Shaded}
...
## 1  train/pos/3100_10.txt        3        7            0            0
## 2    test/neg/3526_3.txt       50       13            0            0
## 3    train/pos/431_8.txt        4       16            0            0
## 4    test/neg/7805_1.txt       11        8            0            0
## 5   train/neg/9509_1.txt        2        2            0            0
## 6    test/neg/5396_1.txt       12       10            0            0
## 7  test/pos/10700_10.txt        6       12            0            0
## 8  train/pos/7290_10.txt        6       18            0            0
## 9   train/neg/9083_1.txt        6        6            0            0
## 10  train/neg/1673_2.txt        3        3            0            0
## 11  train/pos/3483_9.txt        5        4            0            0
## 12  train/pos/2725_8.txt       15       16            0            0
## 13  test/neg/12478_4.txt       24        9            0            0
## 14  train/neg/7808_1.txt       13        8            0            0
## 15   test/neg/3506_1.txt       10        3            0            0
## 16 train/pos/2222_10.txt        2        5            0            0
## 17  train/neg/5629_2.txt        4        7            0            0
## 18   test/neg/6738_2.txt       19       12            0            0
## 19 train/pos/10855_9.txt        8        3            0            0
## 20  test/neg/10208_1.txt        2        4            0            0
## 21 train/pos/3980_10.txt        5        5            0            0
## 22  test/neg/11576_1.txt       12        1            0            0
## 23  test/pos/4186_10.txt        9        9            0            0
## 24   test/neg/3782_1.txt       16        7            0            0
## 25   test/neg/2297_4.txt       18       22            0            0
## 26  train/neg/5049_3.txt        8        9            0            0
## 27  test/pos/7001_10.txt        9       12            0            0
## 28  train/neg/1322_1.txt       13       10            0            0
## 29  train/neg/9251_3.txt        4        1            0            0
## 30   test/neg/2614_3.txt        3        7            0            0
\end{verbatim}
...
\NormalTok{nrepl }\OtherTok{\textless{}{-}} \DecValTok{1000}
\NormalTok{manifBSn }\OtherTok{\textless{}{-}}\NormalTok{ manifBSnRand }\OtherTok{\textless{}{-}}\FunctionTok{array}\NormalTok{(}\FunctionTok{as.matrix}\NormalTok{(reviews\_bootstrap[,}\DecValTok{2}\SpecialCharTok{:}\DecValTok{3}\NormalTok{]),}\FunctionTok{c}\NormalTok{(nman, }\DecValTok{2}\NormalTok{, nrepl }\SpecialCharTok{+} \DecValTok{1}\NormalTok{), }\AttributeTok{dimnames =}\FunctionTok{list}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{nman,}\FunctionTok{names}\NormalTok{(reviews\_bootstrap[,}\DecValTok{2}\SpecialCharTok{:}\DecValTok{3}\NormalTok{]), }\DecValTok{0}\SpecialCharTok{:}\NormalTok{nrepl))}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{CCC}\NormalTok{(comparison}\SpecialCharTok{$}\NormalTok{scores, comparison}\SpecialCharTok{$}\NormalTok{pred\_lbg, }\AttributeTok{ci =} \StringTok{"z{-}transform"}\NormalTok{, }\AttributeTok{conf.level =} \FloatTok{0.95}\NormalTok{, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(comparison, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{scores, }\AttributeTok{y=}\NormalTok{pred\_lbg)) }\SpecialCharTok{+} 
 ...
 \FunctionTok{geom\_abline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{intercept =} \DecValTok{0}\NormalTok{, }\AttributeTok{slope =}\DecValTok{1}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{))}\SpecialCharTok{+}
 \FunctionTok{geom\_abline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{intercept =}\NormalTok{ lm\_line}\SpecialCharTok{$}\NormalTok{coefficients[}\DecValTok{1}\NormalTok{], }\AttributeTok{slope =}\NormalTok{ lm\_line}\SpecialCharTok{$}\NormalTok{coefficients[}\DecValTok{2}\NormalTok{], }\AttributeTok{linetype =} \StringTok{"solid"}\NormalTok{ ))}\SpecialCharTok{+}
 \FunctionTok{scale\_shape\_manual}\NormalTok{(}\AttributeTok{name =} \StringTok{""}\NormalTok{, }\AttributeTok{values=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{), }\AttributeTok{breaks=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{), }\AttributeTok{labels=}\FunctionTok{c}\NormalTok{(}\StringTok{"Line of perfect concordance"}\NormalTok{,}\StringTok{"Reduced major axis"}\NormalTok{))}\SpecialCharTok{+}
 \FunctionTok{scale\_linetype\_manual}\NormalTok{(}\AttributeTok{name =} \StringTok{""}\NormalTok{,}\AttributeTok{values=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{), }\AttributeTok{labels=}\FunctionTok{c}\NormalTok{(}\StringTok{"Line of perfect concordance"}\NormalTok{,}\StringTok{"Reduced major axis"}\NormalTok{))}\SpecialCharTok{+}
 \FunctionTok{theme\_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{textplot\_scale1d}\NormalTok{(ws, }\AttributeTok{margin =} \StringTok{"features"}\NormalTok{, }\AttributeTok{highlighted =}\FunctionTok{c}\NormalTok{(}\StringTok{"british"}\NormalTok{,}\StringTok{"vote"}\NormalTok{, }\StringTok{"europe"}\NormalTok{, }\StringTok{"taxes"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{comparison }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\FunctionTok{rownames}\NormalTok{(comparison), comparison)}
\NormalTok{comparison }\OtherTok{\textless{}{-}} \FunctionTok{as\_tibble}\NormalTok{(comparison }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{textplot }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\FunctionTok{rownames}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(pred\_mv}\SpecialCharTok{$}\NormalTok{se.fit)), pred\_mv}\SpecialCharTok{$}\NormalTok{fit, pred\_mv}\SpecialCharTok{$}\NormalTok{se.fit) }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{fit =} \FunctionTok{as.numeric}\NormalTok{(fit),}
         ...
         \AttributeTok{year =} \FunctionTok{as.factor}\NormalTok{(stringr}\SpecialCharTok{::}\FunctionTok{str\_sub}\NormalTok{(id, }\AttributeTok{start =} \DecValTok{9}\NormalTok{, }\AttributeTok{end =} \DecValTok{12}\NormalTok{))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{arrange}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{fit)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{textplot}\SpecialCharTok{$}\NormalTok{id }\OtherTok{=} \FunctionTok{with}\NormalTok{(textplot,  }\FunctionTok{reorder}\NormalTok{(id, fit))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ textplot, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ fit, }\AttributeTok{y =}\NormalTok{ id)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{colour =}\NormalTok{ year)) }\SpecialCharTok{+}
  \FunctionTok{geom\_errorbarh}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{xmax =}\NormalTok{ upr, }\AttributeTok{xmin =}\NormalTok{ lwr, }\AttributeTok{colour =}\NormalTok{ year), }\AttributeTok{height =} \DecValTok{0}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_classic}\NormalTok{() }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Left{-}Right Distribution of UK Party Manifestos"}\NormalTok{,}
       ...
       \AttributeTok{x =} \StringTok{"Left {-} Right score: lower is more left"}\NormalTok{,}
  ...
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size =} \DecValTok{20}\NormalTok{, }\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{),}
        ...
        \AttributeTok{legend.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{face =} \StringTok{"bold"}\NormalTok{, }\AttributeTok{size =} \DecValTok{10}\NormalTok{, }\AttributeTok{colour =} \StringTok{"grey45"}\NormalTok{),}
        \AttributeTok{legend.text =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size =} \DecValTok{10}\NormalTok{, }\AttributeTok{colour =} \StringTok{"grey45"}\NormalTok{),}
        \AttributeTok{legend.background =} \FunctionTok{element\_rect}\NormalTok{(}\AttributeTok{fill =} \StringTok{"white"}\NormalTok{, }\AttributeTok{colour =} \StringTok{"white"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{wordfish }\OtherTok{\textless{}{-}} \FunctionTok{textmodel\_wordfish}\NormalTok{(data\_manifestos\_dfm, }\AttributeTok{dir =} \FunctionTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{1}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{predict}\NormalTok{(wordfish, }\AttributeTok{interval =} \StringTok{"confidence"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{textplot\_scale1d}\NormalTok{(wordfish, }\AttributeTok{margin =} \StringTok{"features"}\NormalTok{, }\AttributeTok{highlighted =} \FunctionTok{c}\NormalTok{(}\StringTok{"british"}\NormalTok{,}\StringTok{"vote"}\NormalTok{,}\StringTok{"europe"}\NormalTok{,}\StringTok{"election"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{data}\NormalTok{(USCongress)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{container }\OtherTok{\textless{}{-}} \FunctionTok{create\_container}\NormalTok{(doc\_matrix, USCongress}\SpecialCharTok{$}\NormalTok{major, }\AttributeTok{trainSize =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{4000}\NormalTok{, }\AttributeTok{testSize =} \DecValTok{4001}\SpecialCharTok{:}\DecValTok{4449}\NormalTok{, }\AttributeTok{virgin =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{View}\NormalTok{(SVM\_CLASSIFY)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{analytics }\OtherTok{\textless{}{-}} \FunctionTok{create\_analytics}\NormalTok{(container,}\FunctionTok{cbind}\NormalTok{(SVM\_CLASSIFY))}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{detach}\NormalTok{(}\StringTok{"package:RTextTools"}\NormalTok{, }\AttributeTok{unload =} \ConstantTok{TRUE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{detach}\NormalTok{(}\StringTok{"package:httr"}\NormalTok{, }\AttributeTok{unload =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(manifesto\_data}\SpecialCharTok{$}\NormalTok{cmp\_code,manifesto\_data}\SpecialCharTok{$}\NormalTok{party)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{data}\NormalTok{(data\_corpus\_ukmanifestos)}
\NormalTok{corpus\_manifestos }\OtherTok{\textless{}{-}} \FunctionTok{corpus\_subset}\NormalTok{(data\_corpus\_ukmanifestos, Year }\SpecialCharTok{==} \DecValTok{2001}\NormalTok{)}
\NormalTok{corpus\_manifestos }\OtherTok{\textless{}{-}} \FunctionTok{corpus\_subset}\NormalTok{(corpus\_manifestos, Party}\SpecialCharTok{==}\StringTok{"Lab"} \SpecialCharTok{|}\NormalTok{ Party}\SpecialCharTok{==}\StringTok{"LD"} \SpecialCharTok{|}\NormalTok{ Party }\SpecialCharTok{==} \StringTok{"Con"} \SpecialCharTok{|}\NormalTok{ Party}\SpecialCharTok{==} \StringTok{"SNP"} \SpecialCharTok{|}\NormalTok{ Party}\SpecialCharTok{==} \StringTok{"PCy"}\NormalTok{)}
\NormalTok{data\_manifestos\_dfm }\OtherTok{\textless{}{-}} \FunctionTok{dfm}\NormalTok{(corpus\_manifestos, }\AttributeTok{remove =} \FunctionTok{stopwords}\NormalTok{(}\StringTok{"english"}\NormalTok{), }\AttributeTok{remove\_punct =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{remove\_numbers =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{data\_manifestos\_dfm }\OtherTok{\textless{}{-}} \FunctionTok{dfm\_tolower}\NormalTok{(data\_manifestos\_dfm, }\AttributeTok{keep\_acronyms =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{manifestos\_dtm }\OtherTok{\textless{}{-}} \FunctionTok{convert}\NormalTok{(data\_manifestos\_dfm, }\AttributeTok{to =} \StringTok{"topicmodels"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10 }\OtherTok{\textless{}{-}}\FunctionTok{LDA}\NormalTok{(manifestos\_dtm, }\AttributeTok{k=}\DecValTok{10}\NormalTok{, }\AttributeTok{method=}\StringTok{"Gibbs"}\NormalTok{, }\AttributeTok{control=}\FunctionTok{list}\NormalTok{(}\AttributeTok{burnin=}\NormalTok{burnin, }\AttributeTok{iter=}\NormalTok{iter, }\AttributeTok{thin=}\NormalTok{thin, }\AttributeTok{seed=}\NormalTok{seed, }\AttributeTok{nstart=}\NormalTok{nstart, }\AttributeTok{best=}\NormalTok{best))}

\FunctionTok{terms}\NormalTok{(British\_lda10, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{British\_lda10\_topics }\OtherTok{\textless{}{-}} \FunctionTok{tidy}\NormalTok{(British\_lda10, }\AttributeTok{matrix=}\StringTok{"beta"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10\_topterms }\OtherTok{\textless{}{-}}\NormalTok{ British\_lda10\_topics }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10\_topterms }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10\_documents }\OtherTok{\textless{}{-}}\FunctionTok{tidy}\NormalTok{(British\_lda10, }\AttributeTok{matrix=}\StringTok{"gamma"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10\_toptopics }\OtherTok{\textless{}{-}}\NormalTok{ British\_lda10\_documents }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{British\_lda10\_toptopics }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{seededmodel }\OtherTok{\textless{}{-}} \FunctionTok{textmodel\_seededlda}\NormalTok{(data\_manifestos\_dfm, }\AttributeTok{dictionary=}\NormalTok{dict)}
...
\begin{verbatim}
##       CULTURE       ECONOMY      ENVIRONMENT       GROUPS          
##  [1,] "people"      "work"       "environmental"   "women"         
##  [2,] "media"       "children"   "environment"     "race"          
##  [3,] "museums"     "education"  "green"           "ethnic"        
##  [4,] "galleries"   "health"     "population"      "asian"         
##  [5,] "operations"  "investment" "clean"           "girls"         
##  [6,] "operation"   "economic"   "emissions"       "racist"        
##  [7,] "artistic"    "care"       "car"             "racing"        
##  [8,] "operate"     "transport"  "production"      "racial"        
##  [9,] "operating"   "school"     "cleaner"         "racism"        
## [10,] "theatre"     "benefit"    "congestion"      "woman"         
## [11,] "art"         "poverty"    "recycling"       "racially"      
## [12,] "music"       "money"      "products"        "university"    
## [13,] "musical"     "economy"    "environmentally" "rehabilitation"
## [14,] "operated"    "training"   "emission"        "doubled"       
## [15,] "operational" "pay"        "recycle"         "funds"         
## [16,] "operators"   "choice"     "productive"      "depends"       
## [17,] "theatres"    "working"    "litter"          "steps"         
## [18,] "anglers"     "teachers"   "produce"         "comes"         
## [19,] "operates"    "establish"  "product"         "scientists"    
## [20,] "labour"      "child"      "fur"             "employer"      
##       INSTITUTIONS  LAW_AND_ORDER RURAL          URBAN       VALUES          
##  [1,] "reform"      "police"      "farming"      "towns"     "rights"        
##  [2,] "parliament"  "forces"      "fisheries"    "town"      "human"         
##  [3,] "continue"    "prison"      "farmers"      "sense"     "maintain"      
##  [4,] "commission"  "drugs"       "countryside"  "couple's"  "discrimination"
##  [5,] "council"     "victims"     "fishing"      "faith"     "principle"     
##  [6,] "westminster" "fraud"       "agriculture"  "govern"    "threat"        
##  [7,] "councils"    "tough"       "agricultural" "harder"    "leadership"    
##  [8,] "assembly"    "force"       "village"      "try"       "principles"    
##  [9,] "rules"       "drug"        "fish"         "couple"    "proud"         
## [10,] "legislation" "officers"    "wildlife"     "labour"    "past"          
## [11,] "schemes"     "court"       "farms"        "character" "immigration"   
## [12,] "modern"      "courts"      "villages"     "special"   "historic"      
## [13,] "scheme"      "determined"  "farm"         "shops"     "sex"           
## [14,] "process"     "sentences"   "landscape"    "rural"     "leader"        
## [15,] "office"      "sentence"    "fishermen"    "proceeds"  "reliable"      
## [16,] "election"    "policing"    "landscapes"   "list"      "marriage"      
## [17,] "vote"        "forced"      "hens"         "savers"    "history"       
## [18,] "agency"      "offences"    "forest"       "stealth"   "preserve"      
## [19,] "reforms"     "victim"      "feed"         "complex"   "traditions"    
## [20,] "democratic"  "penalties"   "lanes"        "exactly"   "sexual"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{topwords }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{terms}\NormalTok{(seededmodel,}\DecValTok{20}\NormalTok{))}
\NormalTok{corpus\_manifestos}\SpecialCharTok{$}\NormalTok{topic }\OtherTok{\textless{}{-}} \FunctionTok{topics}\NormalTok{(seededmodel)}
\NormalTok{topics\_table }\OtherTok{\textless{}{-}} \FunctionTok{ftable}\NormalTok{(corpus\_manifestos}\SpecialCharTok{$}\NormalTok{topic)}

\NormalTok{topicsprop\_table }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{prop.table}\NormalTok{(topics\_table))}

\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{topicsprop\_table, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Var1, }\AttributeTok{y=}\NormalTok{Freq))}\SpecialCharTok{+}
  ...
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{face=}\StringTok{"bold"}\NormalTok{, }\AttributeTok{size=}\DecValTok{10}\NormalTok{, }\AttributeTok{angle=}\DecValTok{45}\NormalTok{,}\AttributeTok{hjust =} \DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-133-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mca\_tweets }\OtherTok{\textless{}{-}} \FunctionTok{MCA}\NormalTok{(tweets\_mat, }\AttributeTok{ncp=}\DecValTok{5}\NormalTok{, }\AttributeTok{quanti.sup=}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-137-1.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-137-2.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-137-3.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-137-4.pdf}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-139-1.pdf}
...
Merz, Nicolas, Sven Regel, and Jirka Lewandowski. 2016. {``The Manifesto Corpus: A New Resource for Research on Political Parties and Quantitative Text Analysis.''} \emph{Research \& Politics} 3 (2): 2053168016643346.
