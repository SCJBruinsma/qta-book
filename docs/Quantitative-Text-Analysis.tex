...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vector1 <-}\StringTok{ "This is an example of a character vector"}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{files <-}\StringTok{ }\KeywordTok{list.files}\NormalTok{(pdf_directory, }\DataTypeTok{pattern =} \StringTok{".pdf"}\NormalTok{, }\DataTypeTok{recursive =} \OtherTok{FALSE}\NormalTok{, }
...
\NormalTok{        text <-}\StringTok{ }\KeywordTok{pdf_text}\NormalTok{(filename)}
\NormalTok{    \})}
\NormalTok{    f <-}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{"(.*)/([^/]*).pdf"}\NormalTok{, }\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{2"}\NormalTok{, filename)}
...
\NormalTok{directory <-}\StringTok{ }\KeywordTok{getwd}\NormalTok{()}
\NormalTok{data_texts <-}\StringTok{ }\KeywordTok{readtext}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(txt_directory, }\StringTok{"*"}\NormalTok{), }\DataTypeTok{encoding =} \StringTok{"UTF-8"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coderid <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"coder1"}\NormalTok{, }\StringTok{"coder2"}\NormalTok{, }\StringTok{"coder3"}\NormalTok{, }\StringTok{"coder4"}\NormalTok{, }\StringTok{"coder5"}\NormalTok{, }
...
\NormalTok{n <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{163}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{155}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }\DecValTok{164}\NormalTok{, }
    \DecValTok{164}\NormalTok{)}

\NormalTok{data_uncertainty <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(coderid, c0, c01, c02, c03, c04, }
\NormalTok{    c05, c06, c07, c08, c09, c10, c11, c12, c13, c14, c15, c16, }
\NormalTok{    c17, c18, c19, c20, n, }\DataTypeTok{stringsAsFactors =} \OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nman <-}\StringTok{ }\KeywordTok{nrow}\NormalTok{(data_uncertainty)}
\NormalTok{nrepl <-}\StringTok{ }\DecValTok{1000}
\NormalTok{manifBSn <-}\StringTok{ }\NormalTok{manifBSnRand <-}\StringTok{ }\KeywordTok{array}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(data_uncertainty[, }
    \DecValTok{2}\OperatorTok{:}\DecValTok{21}\NormalTok{]), }\KeywordTok{c}\NormalTok{(nman, }\DecValTok{20}\NormalTok{, nrepl }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{), }\DataTypeTok{dimnames =} \KeywordTok{list}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\NormalTok{nman, }\KeywordTok{names}\NormalTok{(data_uncertainty[, }
    \DecValTok{2}\OperatorTok{:}\DecValTok{21}\NormalTok{]), }\DecValTok{0}\OperatorTok{:}\NormalTok{nrepl))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    manifBSn[, , i] <-}\StringTok{ }\KeywordTok{rmultinomial}\NormalTok{(n, p)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{c0SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c0"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c01SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c01"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c02SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c02"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c03SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c03"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c04SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c04"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c05SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c05"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c06SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c06"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c07SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c07"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c08SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c08"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c09SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c09"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c10SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c10"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c11SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c11"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c12SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c12"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c13SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c13"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c14SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c14"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c15SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c15"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c16SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c16"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c17SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c17"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c18SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c18"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{c19SE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c19"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}

\NormalTok{per0 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c0"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per01 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c01"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per02 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c02"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per03 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c03"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per04 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c04"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per05 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c05"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per06 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c06"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per07 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c07"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per08 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c08"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per09 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c09"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per10 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c10"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per11 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c11"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per12 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c12"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per13 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c13"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per14 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c14"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per15 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c15"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per16 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c16"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per17 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c17"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per18 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c18"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{per19 <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"c19"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dataBS <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(data_uncertainty[, }\DecValTok{1}\OperatorTok{:}\DecValTok{22}\NormalTok{], c0SE, c01SE, }
...
\NormalTok{dataBS}\OperatorTok{$}\NormalTok{coderid <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(dataBS}\OperatorTok{$}\NormalTok{coderid, }\KeywordTok{levels}\NormalTok{(dataBS}\OperatorTok{$}\NormalTok{coderid)[}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }
    \DecValTok{5}\OperatorTok{:}\DecValTok{12}\NormalTok{, }\DecValTok{2}\OperatorTok{:}\DecValTok{4}\NormalTok{)])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{c0_lo <-}\StringTok{ }\NormalTok{per0 }\OperatorTok{-}\StringTok{ }\NormalTok{(}\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{c0SE)}
\NormalTok{c0_hi <-}\StringTok{ }\NormalTok{per0 }\OperatorTok{+}\StringTok{ }\NormalTok{(}\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{c0SE)}
\NormalTok{c01_lo <-}\StringTok{ }\NormalTok{per01 }\OperatorTok{-}\StringTok{ }\NormalTok{(}\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{c01SE)}
\NormalTok{c01_hi <-}\StringTok{ }\NormalTok{per01 }\OperatorTok{+}\StringTok{ }\NormalTok{(}\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{c01SE)}
\NormalTok{c02_lo <-}\StringTok{ }\NormalTok{per02 }\OperatorTok{-}\StringTok{ }\NormalTok{(}\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{c02SE)}
\NormalTok{c02_hi <-}\StringTok{ }\NormalTok{per02 }\OperatorTok{+}\StringTok{ }\NormalTok{(}\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{c02SE)}

\NormalTok{dataBS <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{(dataBS, c0_lo, c0_hi, c01_lo, c01_hi, c02_lo, }
\NormalTok{    c02_hi)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(dataBS, }\KeywordTok{aes}\NormalTok{(per0, coderid)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_errorbarh}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xmax =}\NormalTok{ c0_hi, }
    \DataTypeTok{xmin =}\NormalTok{ c0_lo), }\DataTypeTok{height =} \FloatTok{0.2}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Percentage coded to category 0"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Coder ID"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-45-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(dataBS, }\KeywordTok{aes}\NormalTok{(per01, coderid)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_errorbarh}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xmax =}\NormalTok{ c01_hi, }
    \DataTypeTok{xmin =}\NormalTok{ c01_lo), }\DataTypeTok{height =} \FloatTok{0.2}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Percentage coded to category 01"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Coder ID"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(dataBS, }\KeywordTok{aes}\NormalTok{(per02, coderid)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_errorbarh}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xmax =}\NormalTok{ c02_hi, }
    \DataTypeTok{xmin =}\NormalTok{ c02_lo), }\DataTypeTok{height =} \FloatTok{0.2}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Percentage coded to category 02"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Coder ID"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data_manifestos_dfm <-}\StringTok{ }\KeywordTok{dfm}\NormalTok{(corpus_manifestos, }\DataTypeTok{remove =} \KeywordTok{stopwords}\NormalTok{(}\StringTok{"english"}\NormalTok{), }
    \DataTypeTok{remove_punct =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{remove_numbers =} \OtherTok{TRUE}\NormalTok{)}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-53-1.pdf}
...
\KeywordTok{textplot_wordcloud}\NormalTok{(}\KeywordTok{dfm_trim}\NormalTok{(wordcloud_dfm_comp, }\DataTypeTok{min_termfreq =} \DecValTok{20}\NormalTok{, }
    \DataTypeTok{max_words =} \DecValTok{40}\NormalTok{), }\DataTypeTok{comparison =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dic_list <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{economy =} \KeywordTok{c}\NormalTok{(}\StringTok{"tax*"}\NormalTok{, }\StringTok{"vat"}\NormalTok{, }\StringTok{"trade"}\NormalTok{), }\DataTypeTok{social =} \KeywordTok{c}\NormalTok{(}\StringTok{"NHS"}\NormalTok{, }
    \StringTok{"GP"}\NormalTok{, }\StringTok{"health"}\NormalTok{), }\DataTypeTok{devolution =} \KeywordTok{c}\NormalTok{(}\StringTok{"referendum"}\NormalTok{, }\StringTok{"leave"}\NormalTok{, }\StringTok{"independence"}\NormalTok{), }
    \DataTypeTok{europe =} \KeywordTok{c}\NormalTok{(}\StringTok{"Brussels"}\NormalTok{, }\StringTok{"remain"}\NormalTok{, }\StringTok{"EU"}\NormalTok{))}
...
## 1   train/pos/1860_9.txt        1        6            0            0
## 2   test/pos/3946_10.txt       14       15            0            0
## 3     test/pos/896_8.txt       28       30            0            0
## 4    test/neg/8788_2.txt       18       16            0            0
## 5  train/neg/10761_4.txt       18       13            0            0
## 6   train/neg/7017_4.txt       15       25            0            0
## 7   train/neg/3952_1.txt        3        3            0            0
## 8   test/neg/10573_3.txt        3       11            0            0
## 9   test/pos/4800_10.txt        7       10            0            0
## 10  train/neg/9280_1.txt        7        8            0            0
## 11   test/pos/9279_8.txt        4       11            0            0
## 12  train/neg/1433_4.txt        2        7            0            0
## 13   test/neg/2462_2.txt       19       25            0            0
## 14  test/pos/3152_10.txt        5        7            0            0
## 15   train/pos/71_10.txt        8        8            0            0
## 16  test/pos/11336_9.txt       19       15            0            0
## 17   test/neg/9257_4.txt       11        3            0            0
## 18 train/neg/10742_1.txt       13        4            0            0
## 19  train/pos/5657_9.txt        0        3            0            0
## 20  train/pos/8580_9.txt        0        4            0            0
## 21  train/pos/8496_7.txt       10        8            0            0
## 22   test/neg/1914_2.txt       13        6            0            0
## 23 train/pos/1015_10.txt        5        9            0            0
## 24  train/neg/7265_1.txt        9        6            0            0
## 25    test/neg/148_1.txt       13        3            0            0
## 26  test/pos/2197_10.txt        2        7            0            0
## 27 test/pos/10136_10.txt        3        6            0            0
## 28  train/pos/567_10.txt        9       14            0            0
## 29  train/neg/2009_4.txt       17       10            0            0
## 30  train/pos/8031_9.txt        2        4            0            0
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sentiment_difference <-}\StringTok{ }\NormalTok{stargraph}\OperatorTok{$}\NormalTok{positive }\OperatorTok{-}\StringTok{ }\NormalTok{stargraph}\OperatorTok{$}\NormalTok{negative}
\NormalTok{sentiment_ratio <-}\StringTok{ }\NormalTok{(stargraph}\OperatorTok{$}\NormalTok{positive}\OperatorTok{/}\NormalTok{(stargraph}\OperatorTok{$}\NormalTok{positive }\OperatorTok{+}\StringTok{ }
\StringTok{    }\NormalTok{stargraph}\OperatorTok{$}\NormalTok{negative))}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(ggplot2)}
\KeywordTok{ggplot}\NormalTok{(stargraph, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ sentiment_difference, }\DataTypeTok{y =}\NormalTok{ stars)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{shape =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =}\NormalTok{ lm, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Positive minus Negative"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Stars"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-65-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(stargraph, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ sentiment_ratio, }\DataTypeTok{y =}\NormalTok{ stars)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{shape =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =}\NormalTok{ lm, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Ratio of Positive to Total"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Stars"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nman <-}\StringTok{ }\KeywordTok{nrow}\NormalTok{(reviews_bootstrap)}
\NormalTok{nrepl <-}\StringTok{ }\DecValTok{1000}
\NormalTok{manifBSn <-}\StringTok{ }\NormalTok{manifBSnRand <-}\StringTok{ }\KeywordTok{array}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(reviews_bootstrap[, }
    \DecValTok{2}\OperatorTok{:}\DecValTok{3}\NormalTok{]), }\KeywordTok{c}\NormalTok{(nman, }\DecValTok{2}\NormalTok{, nrepl }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{), }\DataTypeTok{dimnames =} \KeywordTok{list}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\NormalTok{nman, }\KeywordTok{names}\NormalTok{(reviews_bootstrap[, }
    \DecValTok{2}\OperatorTok{:}\DecValTok{3}\NormalTok{]), }\DecValTok{0}\OperatorTok{:}\NormalTok{nrepl))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[}\DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(manifBSn), , }\DecValTok{1}\NormalTok{], }\DecValTok{1}\NormalTok{, sum)}
\NormalTok{p <-}\StringTok{ }\NormalTok{manifBSn[, , }\DecValTok{1}\NormalTok{]}\OperatorTok{/}\NormalTok{n}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NegativeSE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"negative"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{PositiveSE <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"positive"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, sd)}
\NormalTok{perNegative <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"negative"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\NormalTok{perPositive <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(manifBSn[, }\StringTok{"positive"}\NormalTok{, ]}\OperatorTok{/}\NormalTok{n }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{, mean)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dataBS <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(reviews_bootstrap[, }\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{], NegativeSE, }
...
\NormalTok{dataBS <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{(dataBS, pos_hi, pos_lo, neg_lo, neg_hi)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-73-1.pdf}
...
\KeywordTok{data}\NormalTok{(data_corpus_ukmanifestos)}
\NormalTok{corpus_manifestos <-}\StringTok{ }\KeywordTok{corpus_subset}\NormalTok{(data_corpus_ukmanifestos, }
\NormalTok{    Year }\OperatorTok{==}\StringTok{ }\DecValTok{2001} \OperatorTok{|}\StringTok{ }\NormalTok{Year }\OperatorTok{==}\StringTok{ }\DecValTok{2005}\NormalTok{)}
\NormalTok{corpus_manifestos <-}\StringTok{ }\KeywordTok{corpus_subset}\NormalTok{(corpus_manifestos, Party }\OperatorTok{==}\StringTok{ }
\StringTok{    "Lab"} \OperatorTok{|}\StringTok{ }\NormalTok{Party }\OperatorTok{==}\StringTok{ "LD"} \OperatorTok{|}\StringTok{ }\NormalTok{Party }\OperatorTok{==}\StringTok{ "Con"} \OperatorTok{|}\StringTok{ }\NormalTok{Party }\OperatorTok{==}\StringTok{ "SNP"} \OperatorTok{|}\StringTok{ }
\StringTok{    }\NormalTok{Party }\OperatorTok{==}\StringTok{ "PCy"}\NormalTok{)}
\NormalTok{data_manifestos_dfm <-}\StringTok{ }\KeywordTok{dfm}\NormalTok{(corpus_manifestos, }\DataTypeTok{remove =} \KeywordTok{stopwords}\NormalTok{(}\StringTok{"english"}\NormalTok{), }
    \DataTypeTok{remove_punct =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{remove_numbers =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{data_manifestos_dfm <-}\StringTok{ }\KeywordTok{dfm_tolower}\NormalTok{(data_manifestos_dfm, }\DataTypeTok{keep_acronyms =} \OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pred_lbg <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(ws, }\DataTypeTok{rescaling =} \StringTok{"lbg"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pred_mv <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(ws, }\DataTypeTok{rescaling =} \StringTok{"mv"}\NormalTok{, }\DataTypeTok{se.fit =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{interval =} \StringTok{"confidence"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{CCC}\NormalTok{(comparison}\OperatorTok{$}\NormalTok{scores, comparison}\OperatorTok{$}\NormalTok{pred_lbg, }\DataTypeTok{ci =} \StringTok{"z-transform"}\NormalTok{, }
    \DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-80-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{textplot_scale1d}\NormalTok{(ws, }\DataTypeTok{margin =} \StringTok{"features"}\NormalTok{, }\DataTypeTok{highlighted =} \KeywordTok{c}\NormalTok{(}\StringTok{"british"}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data_manifestos_dfm <-}\StringTok{ }\KeywordTok{dfm_subset}\NormalTok{(data_manifestos_dfm, Year }\OperatorTok{==}\StringTok{ }\DecValTok{2005}\NormalTok{)}
...
\NormalTok{wordfish <-}\StringTok{ }\KeywordTok{textmodel_wordfish}\NormalTok{(data_manifestos_dfm, }\DataTypeTok{dir =} \KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{textplot_scale1d}\NormalTok{(wordfish, }\DataTypeTok{margin =} \StringTok{"features"}\NormalTok{, }\DataTypeTok{highlighted =} \KeywordTok{c}\NormalTok{(}\StringTok{"british"}\NormalTok{, }
    \StringTok{"vote"}\NormalTok{, }\StringTok{"europe"}\NormalTok{, }\StringTok{"election"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-86-2.pdf}
...
Instead of using a seperate package, we can also use \texttt{quanteda} to carry out an SVM. For this, we again load the reviews we used ealier, select 1000 of them at random, and place them into our corpus:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prop_row <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{((}\KeywordTok{prop.table}\NormalTok{(}\KeywordTok{table}\NormalTok{(manifesto_data}\OperatorTok{$}\NormalTok{cmp_code, }
\NormalTok{    manifesto_data}\OperatorTok{$}\NormalTok{party), }\DecValTok{1}\NormalTok{) }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{))}
...
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ prop_row, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Code, }\DataTypeTok{y =}\NormalTok{ Percentage, }\DataTypeTok{fill =}\NormalTok{ Party)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{scale_fill_manual}\NormalTok{(}\StringTok{""}\NormalTok{, }\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\StringTok{"#0087DC"}\NormalTok{, }\StringTok{"#67B437"}\NormalTok{, }\StringTok{"#DC241F"}\NormalTok{, }
        \StringTok{"#FAA61A"}\NormalTok{, }\StringTok{"#008142"}\NormalTok{, }\StringTok{"#FDF38E"}\NormalTok{, }\StringTok{"#780077"}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat =} \StringTok{"identity"}\NormalTok{, }
    \DataTypeTok{position =} \StringTok{"stack"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{expand =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme_classic}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{vjust =} \FloatTok{0.4}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-106-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prop_col <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{((}\KeywordTok{prop.table}\NormalTok{(}\KeywordTok{table}\NormalTok{(manifesto_data}\OperatorTok{$}\NormalTok{cmp_code, }
\NormalTok{    manifesto_data}\OperatorTok{$}\NormalTok{party), }\DecValTok{2}\NormalTok{) }\OperatorTok{*}\StringTok{ }\DecValTok{100}\NormalTok{))}
...
\NormalTok{prop_col}\OperatorTok{$}\NormalTok{Domain <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(prop_col}\OperatorTok{$}\NormalTok{Domain, }\KeywordTok{levels}\NormalTok{(prop_col}\OperatorTok{$}\NormalTok{Domain)[}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ prop_col, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Party, }\DataTypeTok{y =}\NormalTok{ Percentage, }\DataTypeTok{fill =}\NormalTok{ Domain)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat =} \StringTok{"identity"}\NormalTok{, }\DataTypeTok{position =} \StringTok{"stack"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{expand =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }
    \DecValTok{0}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_classic}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{vjust =} \FloatTok{0.4}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-109-1.pdf}
...
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ table_class, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ predicted_class, }\DataTypeTok{y =}\NormalTok{ actual_class)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_tile}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{fill =}\NormalTok{ Freq)) }\OperatorTok{+}\StringTok{ }\KeywordTok{scale_fill_gradient}\NormalTok{(}\DataTypeTok{high =} \StringTok{"black"}\NormalTok{, }
    \DataTypeTok{low =} \StringTok{"white"}\NormalTok{, }\DataTypeTok{name =} \StringTok{"Value"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Predicted Class"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Actual Class"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{scale_y_discrete}\NormalTok{(}\DataTypeTok{expand =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme_classic}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{vjust =} \FloatTok{0.4}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-117-1.pdf}
...
\KeywordTok{data}\NormalTok{(data_corpus_ukmanifestos)}
\NormalTok{corpus_manifestos <-}\StringTok{ }\KeywordTok{corpus_subset}\NormalTok{(data_corpus_ukmanifestos, }
\NormalTok{    Year }\OperatorTok{==}\StringTok{ }\DecValTok{2001}\NormalTok{)}
\NormalTok{corpus_manifestos <-}\StringTok{ }\KeywordTok{corpus_subset}\NormalTok{(corpus_manifestos, Party }\OperatorTok{==}\StringTok{ }
\StringTok{    "Lab"} \OperatorTok{|}\StringTok{ }\NormalTok{Party }\OperatorTok{==}\StringTok{ "LD"} \OperatorTok{|}\StringTok{ }\NormalTok{Party }\OperatorTok{==}\StringTok{ "Con"} \OperatorTok{|}\StringTok{ }\NormalTok{Party }\OperatorTok{==}\StringTok{ "SNP"} \OperatorTok{|}\StringTok{ }
\StringTok{    }\NormalTok{Party }\OperatorTok{==}\StringTok{ "PCy"}\NormalTok{)}
\NormalTok{data_manifestos_dfm <-}\StringTok{ }\KeywordTok{dfm}\NormalTok{(corpus_manifestos, }\DataTypeTok{remove =} \KeywordTok{stopwords}\NormalTok{(}\StringTok{"english"}\NormalTok{), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British_lda10 <-}\StringTok{ }\KeywordTok{LDA}\NormalTok{(manifestos_dtm, }\DataTypeTok{k =} \DecValTok{10}\NormalTok{, }\DataTypeTok{method =} \StringTok{"Gibbs"}\NormalTok{, }
    \DataTypeTok{control =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{burnin =}\NormalTok{ burnin, }\DataTypeTok{iter =}\NormalTok{ iter, }\DataTypeTok{thin =}\NormalTok{ thin, }
        \DataTypeTok{seed =}\NormalTok{ seed, }\DataTypeTok{nstart =}\NormalTok{ nstart, }\DataTypeTok{best =}\NormalTok{ best))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British_lda10_topterms <-}\StringTok{ }\NormalTok{British_lda10_topics }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(topic) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{top_n}\NormalTok{(}\DecValTok{10}\NormalTok{, beta) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{arrange}\NormalTok{(topic, }\OperatorTok{-}\NormalTok{beta)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British_lda10_topterms }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{term =} \KeywordTok{reorder}\NormalTok{(term, beta)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(term, beta, }\DataTypeTok{fill =} \KeywordTok{factor}\NormalTok{(topic))) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_col}\NormalTok{(}\DataTypeTok{show.legend =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\NormalTok{topic, }\DataTypeTok{scales =} \StringTok{"free"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{coord_flip}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-126-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British_lda10_documents <-}\StringTok{ }\KeywordTok{tidy}\NormalTok{(British_lda10, }\DataTypeTok{matrix =} \StringTok{"gamma"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British_lda10_toptopics <-}\StringTok{ }\NormalTok{British_lda10_documents }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(document) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{top_n}\NormalTok{(}\DecValTok{10}\NormalTok{, gamma) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{arrange}\NormalTok{(topic, }\OperatorTok{-}\NormalTok{gamma)}

\NormalTok{British_lda10_toptopics }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{term =} \KeywordTok{reorder}\NormalTok{(topic, gamma)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(topic, gamma, }\DataTypeTok{fill =} \KeywordTok{factor}\NormalTok{(topic))) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_col}\NormalTok{(}\DataTypeTok{show.legend =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DecValTok{7}\NormalTok{, }\DecValTok{8}\NormalTok{, }\DecValTok{9}\NormalTok{, }
        \DecValTok{10}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\NormalTok{document, }\DataTypeTok{scales =} \StringTok{"free"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{coord_flip}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-128-1.pdf}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-132-1.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-132-2.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-132-3.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-132-4.pdf}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-134-1.pdf}
