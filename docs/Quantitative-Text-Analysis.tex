...
\begin{verbatim}
##  ...UK_natl_2001_en_Con to UK_natl_2005_en_SNP
\end{verbatim}
...
\begin{verbatim}
##  ...complete, elapsed time: 0.59 seconds.
\end{verbatim}

\begin{verbatim}
## Finished constructing tokens from 10 documents.
\end{verbatim}
...
\NormalTok{wordcloud\_dfm\_comp }\OtherTok{\textless{}{-}} \FunctionTok{dfm\_group}\NormalTok{(data\_manifestos\_dfm, }\AttributeTok{groups =}\NormalTok{ Party)}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-58-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dic\_list }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\AttributeTok{economy =} \FunctionTok{c}\NormalTok{(}\StringTok{"tax*"}\NormalTok{, }\StringTok{"vat"}\NormalTok{, }\StringTok{"trade"}\NormalTok{), }\AttributeTok{social =} \FunctionTok{c}\NormalTok{(}\StringTok{"NHS"}\NormalTok{, }
    \StringTok{"GP"}\NormalTok{, }\StringTok{"health"}\NormalTok{), }\AttributeTok{devolution =} \FunctionTok{c}\NormalTok{(}\StringTok{"referendum"}\NormalTok{, }\StringTok{"leave"}\NormalTok{, }\StringTok{"independence"}\NormalTok{), }
    \AttributeTok{europe =} \FunctionTok{c}\NormalTok{(}\StringTok{"Brussels"}\NormalTok{, }\StringTok{"remain"}\NormalTok{, }\StringTok{"EU"}\NormalTok{))}
...
\begin{verbatim}
## Document-feature matrix of: 10 documents, 4 features (2.50% sparse) and 6 docvars.
##                      features
...
## 1    test/neg/1746_3.txt        8       11            0            0
## 2    test/pos/8022_7.txt        8       15            0            0
## 3    test/neg/6285_1.txt        8       10            0            0
## 4    test/neg/5433_1.txt        2        2            0            0
## 5    test/neg/6994_4.txt       10       12            0            0
## 6   train/pos/6898_9.txt        9       15            0            0
## 7   test/pos/10558_9.txt        2        7            0            0
## 8    test/pos/3452_7.txt        6       16            0            0
## 9   test/neg/11831_4.txt        3        4            0            0
## 10  train/neg/4118_3.txt        5        4            0            0
## 11    train/neg/59_3.txt        2        6            0            0
## 12  train/neg/8446_1.txt        7        1            0            0
## 13  train/neg/1287_3.txt       38       30            0            0
## 14   test/neg/4263_3.txt        6       15            0            0
## 15   train/neg/574_4.txt        2        4            0            0
## 16   test/pos/6444_7.txt        1       11            0            0
## 17  test/pos/3043_10.txt       22       36            0            0
## 18    test/neg/473_1.txt       21        9            0            0
## 19  train/neg/8918_3.txt       23       12            0            0
## 20    test/pos/670_7.txt       14       12            0            0
## 21  train/neg/1880_4.txt        2        7            0            0
## 22   test/neg/4786_4.txt       16       17            0            0
## 23  test/pos/5316_10.txt        4       11            0            0
## 24  test/pos/11130_8.txt       18       33            0            0
## 25 train/neg/10707_1.txt       13        2            0            0
## 26  test/pos/5492_10.txt        9       14            0            0
## 27  train/neg/8082_3.txt       10       11            0            0
## 28  test/pos/7525_10.txt        9        6            0            0
## 29  train/pos/1240_7.txt       14       24            0            0
## 30 train/neg/12227_1.txt       14        7            0            0
\end{verbatim}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-68-1.pdf}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-69-1.pdf}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-85-1.pdf}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-88-1.pdf}
...
\NormalTok{wordfish }\OtherTok{\textless{}{-}} \FunctionTok{textmodel\_wordfish}\NormalTok{(data\_manifestos\_dfm, }\AttributeTok{dir =} \FunctionTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{, }
...
## psi      1.303     -1.653  1.5034    0.7156    1.7173
\end{verbatim}
...
## UK_natl_2005_en_SNP -2.41198751 -2.42683400 -2.3971410
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{textplot\_scale1d}\NormalTok{(wordfish, }\AttributeTok{margin =} \StringTok{"features"}\NormalTok{, }\AttributeTok{highlighted =} \FunctionTok{c}\NormalTok{(}\StringTok{"british"}\NormalTok{, }
    \StringTok{"vote"}\NormalTok{, }\StringTok{"europe"}\NormalTok{, }\StringTok{"election"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-91-1.pdf}
...
Instead of using a separate package, we can also use \texttt{quanteda} to carry out an SVM. For this, we again load the reviews we used earlier, select 1000 of them at random, and place them into our corpus:
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-116-1.pdf}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-124-1.pdf}
...
\FunctionTok{data}\NormalTok{(data\_corpus\_ukmanifestos)}
\NormalTok{corpus\_manifestos }\OtherTok{\textless{}{-}} \FunctionTok{corpus\_subset}\NormalTok{(data\_corpus\_ukmanifestos, }
\NormalTok{    Year }\SpecialCharTok{==} \DecValTok{2001}\NormalTok{)}
\NormalTok{corpus\_manifestos }\OtherTok{\textless{}{-}} \FunctionTok{corpus\_subset}\NormalTok{(corpus\_manifestos, Party }\SpecialCharTok{==} 
    \StringTok{"Lab"} \SpecialCharTok{|}\NormalTok{ Party }\SpecialCharTok{==} \StringTok{"LD"} \SpecialCharTok{|}\NormalTok{ Party }\SpecialCharTok{==} \StringTok{"Con"} \SpecialCharTok{|}\NormalTok{ Party }\SpecialCharTok{==} \StringTok{"SNP"} \SpecialCharTok{|} 
\NormalTok{    Party }\SpecialCharTok{==} \StringTok{"PCy"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10 }\OtherTok{\textless{}{-}} \FunctionTok{LDA}\NormalTok{(manifestos\_dtm, }\AttributeTok{k =} \DecValTok{10}\NormalTok{, }\AttributeTok{method =} \StringTok{"Gibbs"}\NormalTok{, }
...
##  [1,] "scotland"     "people"  "per"        "long-term" "national"  
##  [2,] "snp"          "local"   "labour"     "control"   "need"      
##  [3,] "scottish"     "new"     "new"        "workers"   "government"
##  [4,] "scotland's"   "support" "cent"       "coming"    "europe"    
##  [5,] "independence" "also"    "services"   "efforts"   "parliament"
##  [6,] "taxation"     "work"    "now"        "career"    "want"      
##  [7,] "key"          "tax"     "million"    "usa"       "benefit"   
##  [8,] "rural"        "make"    "help"       "can"       "one"       
##  [9,] "mps"          "schools" "investment" "authority" "must"      
## [10,] "westminster"  "policy"  "work"       "poorer"    "level"     
##       Topic 6      Topic 7     Topic 8       Topic 9         Topic 10       
##  [1,] "public"     "wales"     "funded"      "liberal"       "government"   
##  [2,] "government" "party"     "bureaucracy" "s"             "time"         
##  [3,] "system"     "social"    "run"         "also"          "conservatives"
##  [4,] "ensure"     "health"    "decisions"   "democrats"     "conservative" 
##  [5,] "education"  "powers"    "away"        "transport"     "businesses"   
##  [6,] "european"   "assembly"  "distinct"    "environmental" "common"       
##  [7,] "uk"         "shall"     "nothing"     "green"         "tax"          
##  [8,] "establish"  "order"     "disease"     "energy"        "taxes"        
##  [9,] "investment" "important" "power"       "nations"       "sense"        
## [10,] "end"        "economic"  "loan"        "eu"            "patients"
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10\_topterms }\OtherTok{\textless{}{-}}\NormalTok{ British\_lda10\_topics }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(topic) }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{top\_n}\NormalTok{(}\DecValTok{10}\NormalTok{, beta) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ungroup}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(topic, }\SpecialCharTok{{-}}\NormalTok{beta)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10\_topterms }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{term =} \FunctionTok{reorder}\NormalTok{(term, beta)) }\SpecialCharTok{\%\textgreater{}\%} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{British\_lda10\_toptopics }\OtherTok{\textless{}{-}}\NormalTok{ British\_lda10\_documents }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(document) }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{top\_n}\NormalTok{(}\DecValTok{10}\NormalTok{, gamma) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ungroup}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(topic, }\SpecialCharTok{{-}}\NormalTok{gamma)}

\NormalTok{British\_lda10\_toptopics }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{term =} \FunctionTok{reorder}\NormalTok{(topic, gamma)) }\SpecialCharTok{\%\textgreater{}\%} 
...
##  [6,] "operating"   "economic"   "emissions"       "racist"     "westminster"
##  [7,] "artistic"    "care"       "production"      "racing"     "councils"   
##  [8,] "theatre"     "transport"  "car"             "racial"     "assembly"   
##  [9,] "art"         "school"     "cleaner"         "racism"     "rules"      
## [10,] "operation"   "benefit"    "congestion"      "woman"      "legislation"
## [11,] "music"       "poverty"    "recycling"       "racially"   "process"    
## [12,] "musical"     "economy"    "products"        "scotland"   "schemes"    
## [13,] "operated"    "money"      "environmentally" "snp"        "modern"     
## [14,] "operational" "training"   "emission"        "scottish"   "scheme"     
## [15,] "theatres"    "pay"        "recycle"         "scotland's" "office"     
## [16,] "anglers"     "choice"     "productive"      "taxation"   "election"   
## [17,] "operate"     "working"    "litter"          "key"        "vote"       
## [18,] "operators"   "teachers"   "product"         "stand"      "agency"     
## [19,] "operates"    "establish"  "fur"             "review"     "democratic" 
## [20,] "labour"      "child"      "chemical"        "mps"        "management" 
##       LAW_AND_ORDER RURAL          URBAN       VALUES          
##  [1,] "police"      "farming"      "towns"     "rights"        
##  [2,] "forces"      "fisheries"    "town"      "human"         
##  [3,] "prison"      "farmers"      "gps"       "maintain"      
##  [4,] "drugs"       "countryside"  "stronger"  "discrimination"
##  [5,] "victims"     "fishing"      "govern"    "principle"     
##  [6,] "fraud"       "agriculture"  "taken"     "threat"        
##  [7,] "tough"       "agricultural" "source"    "leadership"    
##  [8,] "force"       "village"      "insist"    "principles"    
##  [9,] "drug"        "fish"         "harder"    "proud"         
## [10,] "officers"    "wildlife"     "transfer"  "past"          
## [11,] "court"       "farms"        "modest"    "immigration"   
## [12,] "courts"      "villages"     "character" "historic"      
## [13,] "determined"  "farm"         "habit"     "sex"           
## [14,] "sentences"   "landscape"    "stealth"   "leader"        
## [15,] "sentence"    "fishermen"    "driven"    "marriage"      
## [16,] "policing"    "landscapes"   "alongside" "reliable"      
## [17,] "forced"      "hens"         "losing"    "history"       
## [18,] "offences"    "forest"       "channel"   "preserve"      
## [19,] "victim"      "feed"         "real"      "traditions"    
## [20,] "penalties"   "lanes"        "bogus"     "sexual"
\end{verbatim}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-143-1.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-143-2.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-143-3.pdf} \includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-143-4.pdf}
...
\includegraphics{Quantitative-Text-Analysis_files/figure-latex/unnamed-chunk-145-1.pdf}
