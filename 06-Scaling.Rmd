...
```
```{r wordfish-model, message = FALSE, eval=FALSE}
...
```{r wordfish-predict, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r wordfish-textplot-features, message=FALSE, warning=FALSE, eval=FALSE}
library(quanteda.textplots)
...
```{r wordfish-textplot-documents, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r mca-trumptweets, results='hide', warning=FALSE, eval=FALSE}
mca_tweets <- MCA(tweets_mat, ncp=2, quanti.sup=1, graph = FALSE)
```
...
```{r trumptweets-quanti, eval=FALSE}
...
```{r trumptweets-fvizvar, eval=FALSE}
...
```{r trumptweets-coordinates, eval=FALSE}
...
```{r trumptweets-fvizind, eval=FALSE}
